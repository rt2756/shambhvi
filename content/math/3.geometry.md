...
- **Angle of rotation** = `360° ÷ order` (square → `360° ÷ 4 = 90°` · equilateral triangle → `360° ÷ 3 = 120°`).
- **Regular polygon with n sides:** **n lines** of symmetry **and** rotational symmetry of **order n** (regular pentagon → 5 and 5).
