...
- 5 + 3. Start from 5. **+ means move right**. +3 means move right by 3 steps. So 3 steps right from 5 lands us at 8. S0 5 + 3 = 8.
...
**Mix of both +ve and -ve**
- **Larger - Smaller: no problem**
  - +8 -5 = 3
- `Smaller - Larger: Caution`
  - +5 -8
    - `Do Larger - Smaller`, 8 -5 = 3
    - `Then apply -ve sign at the end`, -3
  - So +5 - 8 = -3
